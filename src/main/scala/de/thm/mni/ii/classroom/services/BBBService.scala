...
import de.thm.mni.ii.classroom.services.conference.{BBBConference, Conference}
...
class BBBService(templateBuilder: RestTemplateBuilder,
  ...
  /**
    ...
    * @param id de.thm.mni.ii.classroom.services.conferences.conference.Conference id to register.
    * @param meetingName de.thm.mni.ii.classroom.services.conferences.conference.Conference id to register.
