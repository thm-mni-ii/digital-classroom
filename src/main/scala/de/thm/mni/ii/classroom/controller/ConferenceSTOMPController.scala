...
import de.thm.mni.ii.classroom.model.CourseRole
import de.thm.mni.ii.classroom.services.conference.Conference
import de.thm.mni.ii.classroom.services.memory.UserService
import de.thm.mni.ii.classroom.services.{AuthService, BBBService, ConferenceServiceFactoryService, CourseAuthService}
...
class ConferenceSTOMPController {
  ...
  UserConferenceMap.onLastDelete((conference: Conference) => conference.end())
}
