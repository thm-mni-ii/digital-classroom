...
class MeetingInfoBBBResponse(
    ...
    @XmlElement private val participantCount = users.size
    @XmlElement private val listenerCount = users.size
    @XmlElement private val voiceParticipantCount = 0
    @XmlElement private val videoCount = users.size
    @XmlElement private val maxUsers = 100
    @XmlElement private val moderatorCount = users.filter { it.isPrivileged() }.size
    @XmlElement private val attendees = users.map(::Attendee)
