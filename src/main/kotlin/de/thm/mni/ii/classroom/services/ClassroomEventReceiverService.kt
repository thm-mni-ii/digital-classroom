...
class ClassroomEventReceiverService(
    ...
    private fun conferenceEventReceived(userCredentials: UserCredentials, conferenceEvent: ConferenceEvent) {
        when (conferenceEvent.conferenceAction) {
            ...
            ConferenceAction.HIDE -> conferenceService.hideConference(userCredentials, conferenceEvent.conferenceInfo)
            ConferenceAction.PUBLISH -> conferenceService.publishConference(userCredentials, conferenceEvent.conferenceInfo)
